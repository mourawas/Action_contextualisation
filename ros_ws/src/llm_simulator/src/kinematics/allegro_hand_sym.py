...
class Robot:
    def __init__(self,
                 ...
                 description_folder: str = 'description',
                 kinematics_folder: str = 'kinematics') -> None:
        if right_hand:
            path = description_folder + '/allegro_all/allegro_right_bodies.xml'
            file_name = kinematics_folder + '/q2pose_right.txt'
        else:
            path = description_folder + '/allegro_all/allegro_left_bodies.xml'
            file_name = kinematics_folder + '/q2pose_left.txt'
        tree = ET.parse(path)
        ...
        if os.path.isfile(file_name):
            ...
            print('Start to load xml file to build the kinematics. This might take about 20s, but only for the first time.')
